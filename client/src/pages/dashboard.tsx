  ...
  return (
    <div className="p-6 bg-light-grey min-h-full overflow-auto" data-testid="dashboard-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="card-hover border-2 border-gray-200 hover:border-coral/30">
        ...
        <Card className="card-hover border-2 border-gray-200 hover:border-green-300">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card className="card-hover border-2 border-gray-200 hover:border-slate-blue/30">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/flows">
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="btn-hover border-2 border-gray-300 hover:border-coral hover:bg-coral hover:text-white"
